...
(function () {
  ...
  /* Inline-SVG line icons (emoji removed 25 Sep 2026: no emoji icons, RM's numbered-index decision).
     Same set as graco-pages/assets/quote-builder.js. */
  var IC = {
    toolbox: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="3" y="8" width="18" height="12" rx="2"/><path d="M8 8V6a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M3 13h18"/><path d="M10 13v2M14 13v2"/></svg>',
    tool: '<svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M14.7 6.3a4 4 0 0 0-5.66 5.66l-6.34 6.34 2 2 6.34-6.34a4 4 0 0 0 5.66-5.66l-2.83 2.83-2.83-2.83 2.83-2.83z"/></svg>',
    bolt: '<svg viewBox="0 0 24 24" fill="none" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M9 4h6l3 3v3l-3 3H9l-3-3V7z"/><path d="M12 16v4"/></svg>'
  };
  ...
  function render() {
    ...
    if (body) {
      if (!items.length) {
        body.innerHTML =
          '<div class="qb-empty"><div class="qb-empty-icon">' + IC.toolbox + '</div>' +
        ...
        body.innerHTML = items.map(function (i) {
          var icon = i.type === 'consumable' ? IC.bolt : IC.tool;
  ...
  function buildUI() {
    ...
    fab.innerHTML = IC.toolbox + ' <span>My Quote</span> <span class="qb-fab-count">0</span>';
    ...
    drawer.innerHTML =
      '<div class="qb-drawer-head" style="justify-content:space-between"><h3>' + IC.toolbox + ' Your Quote List</h3>' +
