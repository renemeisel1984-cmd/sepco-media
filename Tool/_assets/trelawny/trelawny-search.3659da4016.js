/* ============================================================
   ...
   ============================================================ */
(function(){
  var SVG_MAG = '<svg viewBox="0 0 24 24" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" aria-hidden="true"><circle cx="11" cy="11" r="7"/><line x1="20" y1="20" x2="16.65" y2="16.65"/></svg>';   /* emoji magnifier removed 25 Sep 2026; same SVG as coltraco-search.js */
  // n=name, m=model/part, c=category, u=url(#anchor), i=IMPA code, t=tag
  var DATA = [
    // --- Needle Scalers ---
    {n:"Low-Vibration Pistol-Grip Needle Scaler", m:"VL203", c:"Needle Scalers", u:"needle-scalers.html#g-low", t:"Low HAVS"},
    {n:"Low-Vibration In-Line Needle Scaler", m:"VL223", c:"Needle Scalers", u:"needle-scalers.html#g-low", t:"Low HAVS"},
    {n:"Heavy-Duty Low-Vibration Needle Scaler", m:"VL303", c:"Needle Scalers", u:"needle-scalers.html#g-low", t:"Low HAVS"},
    {n:"Standard Pistol-Grip Needle Scaler", m:"2BPG", c:"Needle Scalers", u:"needle-scalers.html#g-std"},
    {n:"Standard Barrel-Grip Needle Scaler", m:"2B", c:"Needle Scalers", u:"needle-scalers.html#g-std"},
    {n:"Standard In-Line Needle Scaler", m:"1B", c:"Needle Scalers", u:"needle-scalers.html#g-std"},
    {n:"TVS Needle Scaler", m:"TVS · VL203", c:"Needle Scalers", u:"needle-scalers.html#g-tvs", t:"Lowest HAVS"},
    {n:"Needle / Chisel Scaler Kit", m:"Cased kit", c:"Needle Scalers", u:"needle-scalers.html#g-kit"},
    {n:"Long-Reach Needle / Chisel Scaler", m:"Long reach", c:"Needle Scalers", u:"needle-scalers.html#g-lr"},
    {n:"Long-Reach Needle / Chisel Scaler Kit", m:"Long reach · cased", c:"Needle Scalers", u:"needle-scalers.html#g-lr"},
    // --- Scaling Hammers ---
    ...
    // --- Deck Scalers ---
    {n:"TFP200 Deck Scaler", m:"TFP200 · TFP200-VM VoltMax battery · 320.2520T · 320.2528T · 200 mm", c:"Deck Scalers", u:"deck-scalers.html#products"},
    ...
    {n:"TVS Vacuum Shroud (VL203/223)", m:"418.2003", c:"Needle Scaler Consumables", u:"needle-scalers.html#g-tvs", i:"59.25.06"},
    ...
    {n:"Vibration Comparison: Every Trelawny Tool", m:"m/s² · declared vibration · trigger time · EAV · ELV · HAVS", c:"Resource & guidance", u:"vibration-comparison.html", t:"Guide"},
    {n:"Planning Guides", m:"guides · production rate · vibration · blasting · Zone 1 · lead paint", c:"Resource & guidance", u:"guides.html", t:"Guide"},
    {n:"Downloads: Datasheets, Manuals & Brochures", m:"datasheet · manual · brochure · PDF · ATEX certificate", c:"Resource & guidance", u:"downloads.html", t:"Guide"},
    {n:"Support & Delivery", m:"ordering · delivery · ShipServ · TN 317548 · warranty · service kit · spares", c:"Resource & guidance", u:"support-delivery.html", t:"Guide"},
    ...
    {n:"Water Blasting vs Mechanical Scaling", m:"UHP jetting · flash rust · MARPOL · cost per m²", c:"Resource & guidance", u:"prepare-steel-without-blasting.html#the-two-methods", t:"Guide"},
    {n:"Deck Descaling Output per Operator per Day", m:"production rate · m² per shift · m²/hr per operator · operator-hours · A(8) trigger time · compressor sizing · SF11 · TFP200 · PPT · Trident · perimeter · planner", c:"Resource & guidance", u:"deck-descaling-production-rate.html", t:"Guide"},
  ...
  function build(){
    ...
    btn.innerHTML = '<span class="tr-search-ico">' + SVG_MAG + '</span><span class="tr-search-label">Search products</span><span class="tr-search-hint">/</span>';
    ...
    ov.innerHTML =
      '<div class="tr-search-panel" role="dialog" aria-label="Product search">' +
        '<div class="tr-search-inputwrap"><span class="tr-search-ico">' + SVG_MAG + '</span>' +
